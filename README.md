...
- **代码配套**：提供不依赖具体芯片库的 C 语言教学示例，并补充 Qt Modbus 调试上位机最小 Demo，方便理解协议接收、CRC16、Modbus 03/06 功能码和上位机日志。
...
如果想看上位机如何组织代码，可以继续阅读 [Qt Modbus 调试上位机最小 Demo](07_Qt上位机/qt_modbus_debugger_demo/README.md)。这个 Demo 只做教学用途，重点展示串口收发、03/06 组帧、CRC 校验和 TX/RX 日志，不绑定任何真实设备协议。
